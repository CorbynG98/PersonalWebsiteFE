...
export default function HomePage() {
  const [hovered, setHovered] = useState({ title: true, projects: false, about: false, connect: false })
  ...
  const setAttribute = (width: any, height: any, colour: any) => {
    return 'width:' + width + 'vw; height: ' + height + 'vh; background-color:' + colour + "; display: flex";
  }
  ...
  const mouseEnterResize = (id: string, leaveSize: boolean = false) => {
    ...
    if (!leaveSize) {
      for (let i = 0; i < items.length; i++) {
        ...
        itemAttribute = setAttribute(itemWidth, itemHeight, colour ?? "transparent");
  ...
  const mobileFriendlyUI = () => {
    return (
      <React.Fragment>
        <div id="mobileHome" style={{ display: 'grid', gridTemplateRows: '3fr 1fr 1fr 1fr', gridTemplateColumns: '1fr', height: '100vh', width: '100vw' }}>
          <Nav.Link
            ...
            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid white', backgroundColor: "#55cc69", height: 'auto', width: 'auto' }}>
            <div style={{ margin: 'auto' }}>
              <div className='meContainer'>
                <div className='mePhoto' style={hovered.title ? { height: "16rem", width: "16rem" } : { height: "10rem", width: "10rem" }}>
                  <img
                    src='https://storage.googleapis.com/public_images_ctg/hopefully-square.jpg'
                    className='mePhoto'
                    style={hovered.title ? { height: "16rem", width: "16rem" } : { height: "10rem", width: "10rem" }}
              ...
              <div className='smallBlurb'>
                ...
                <span className={`blurb-p overridePrimaryColour`} id="colourBlurb">Developer</span>&nbsp;|&nbsp;
          ...
          <Nav.Link
            ...
            to='/Projects'
            className='linkStyle specialLinkStyle linkItem'
            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid white', borderTop: '1px solid white', height: 'auto', width: 'auto' }}>
            <div style={{ margin: 'auto' }}>
              <p style={{ fontSize: '3rem', fontWeight: 'bold', color: "#55cc69", transition: "all 0.6s ease" }} className={(hovered.projects ? "overridePrimaryColourWhite" : "")}>PROJECTS</p>
            </div>
          </Nav.Link>
          <Nav.Link
            ...
            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid white', borderTop: '1px solid white', height: 'auto', width: 'auto' }}>
            <div style={{ margin: 'auto' }}>
              <p style={{ fontSize: '3rem', fontWeight: 'bold', color: "#55cc69", transition: "all 0.6s ease" }} className={(hovered.about ? "overridePrimaryColourWhite" : "")}>ABOUT</p>
            </div>
          </Nav.Link>
          <Nav.Link
            ...
            to='/Contact'
            className='linkStyle specialLinkStyle linkItem'
            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', borderTop: '1px solid white', height: 'auto', width: 'auto' }}>
            <div style={{ margin: 'auto' }}>
              <p style={{ fontSize: '3rem', fontWeight: 'bold', color: "#55cc69", transition: "all 0.6s ease" }} className={(hovered.connect ? "overridePrimaryColourWhite" : "")}>CONNECT</p>
            </div>
          </Nav.Link>
        </div>
        <Snowfall />
        ...
        <div id="homePage" className={`homePageNavContainer`}>
          <Nav.Link
            ...
            <div style={{ margin: 'auto' }}>
              ...
              <div className='smallBlurb'>
                <span className='blurb-p'>Software Engineer</span>&nbsp;|&nbsp;
                <span className={`blurb-p ${(hovered.title ? "overridePrimaryColour" : "")}`} id="colourBlurb">Developer</span>&nbsp;|&nbsp;
                <span className='blurb-p'>Designer</span>
              </div>
            </div>
          </Nav.Link>
