...
export const Renderer = () => {
  ...
  const [loginErrorMessage, setLoginErrorMessage] = useState<string|undefined|null>(null);
  // Selector stuff
  ...
  return (
    <HelmetProvider>
        ...
        <Modal show={isLoginModalVisible} onHide={() => setLoginModalVisible(false)} centered>
            ...
            <Form noValidate validated={formValidated} onSubmit={attemptLogin}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="secondary" onClick={() => setLoginModalVisible(false)} disabled={loginLoading}>
                    Close
                    </Button>
