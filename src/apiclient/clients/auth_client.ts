...
export const Authenticate = async (data: LoginData, cancelToken: CancelTokenSource|undefined|null = null): Promise<LoginResponse> => {
...
export const Signout = async (cancelToken: CancelTokenSource|undefined|null = null) => {
    ...
    try {
        await axios.post<null, AxiosResponse<null>>(
            endpoint,
            null,
            { cancelToken: cancelToken?.token }
        );
